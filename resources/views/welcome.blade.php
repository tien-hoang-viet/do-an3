...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ route('homepage') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Home
                Page</a>
        </div>
...
<script type="module">
    ...
    const firebaseConfig = {
        apiKey: "AIzaSyCLC3aF2Zylq4nffmshDfgDO1r-Z2dRBo4",
        authDomain: "tien-92a5b.firebaseapp.com",
        projectId: "tien-92a5b",
        storageBucket: "tien-92a5b.appspot.com",
        messagingSenderId: "832645492336",
        appId: "1:832645492336:web:0e7653b764101f827a8eb5",
        measurementId: "G-2BMV7Y3BWD"
    };
