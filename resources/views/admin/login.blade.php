...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/admin_assets/app-assets/css/components.css">
    <link rel="stylesheet" type="text/css" href="/admin_assets/app-assets/css/themes/dark-layout.css">
    <link rel="stylesheet" type="text/css" href="/admin_assets/app-assets/css/themes/bordered-layout.css">
    ...
    <link rel="stylesheet" type="text/css" href="/admin_assets/app-assets/css/pages/page-auth.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
    ...
    <div class="app-content content ">
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="/admin_assets/app-assets/images/pages/login-v2-dark.svg"
                                    alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
        ...
        <!-- BEGIN: Page JS-->
        <script src="/admin_assets/app-assets/js/scripts/pages/page-auth-login.js"></script>
        <!-- END: Page JS-->
