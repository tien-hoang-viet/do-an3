<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('admin.home') }}"><span
                        class="brand-logo">
            ...
            @can('role-nav')
                <li class=" nav-item {{ request()->is('admin/role*') ? 'active' : '' }}">
                    ...
                    <ul class="menu-content">
                        ...
                        @can('create-role')
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('role.create') }}">
                                    <i data-feather="circle"></i>
            ...
            @can('admin-nav')
                <li class=" nav-item {{ request()->is('admin/manager*') ? 'active' : '' }}">
                    ...
                    <ul class="menu-content">
                        ...
                        @can('create-admin')
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('admin.create') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate">Create</span>
                                </a>
                            </li>
            ...
            @can('promotion-nav')
                <li class=" nav-item  {{ request()->is('admin/promotion*') ? 'active' : '' }}">
                    ...
                    <ul class="menu-content">
                        @can('read-promotion')
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('promotion.index') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate">View</span>
                                </a>
                            </li>
                        ...
                        @can('create-promotion')
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('promotion.create') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate">Create</span>
                                </a>
                            </li>
